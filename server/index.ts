...
import { readNotifications } from "./controller";
...
usersNameSpace.use((socket, next) => authoriseUserIoConnection(socket, next));
usersNameSpace.on("read_notification", (notificationIds: string[]) => {
...
export { httpServer, usersNameSpace };
